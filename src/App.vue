<template>
  <div class="bg-[#181F1C] flex justify-center items-center h-screen ">
    <div class="flex flex-row bg-div-p rounded-md ">
      <div class="w-60">
        ...
        <Linha />
        <div class="bg-div pl-5 drop-shadow-lg">
          <ul class="list-disc ml-5 mr-5 pb-3 text-slate-300 font-normal">
            <li>Tailwind</li>
            <li>Nuxt</li>
            <li>Vuetify</li>
          </ul>
        ...
        <Linha />
        <div class="bg-div pl-5 drop-shadow-lg">
          <a href="#" class="text-slate-300 font-normal">DOWNLOAD CV</a>
        </div>
        <div class="bg-div-foto pt-2 pb-2 pl-5 drop-shadow-lg flex flex-row">
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-3 w-3 bg-slate-50">
              <path
